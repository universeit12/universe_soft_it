...
class FacultyDetails extends StatelessWidget {
  const FacultyDetails({super.key, required this.faculty, required this.onTap});
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            faculty.backgroundOfStudy.toString(),
                            style: TextStyle(
                                fontSize: 19.sp,
                                fontFamily: "FontMain2",
                                letterSpacing: 0.5),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            faculty.jobExperience.toString(),
                            style: TextStyle(
                                fontSize: 19.sp,
                                fontFamily: "FontMain2",
                                letterSpacing: 0.5),
